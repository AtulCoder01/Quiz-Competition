...
$q = "CREATE TABLE student_details_tb (stu_id varchar(11) PRIMARY KEY, name varchar(30) NOT NULL, course varchar(10) NOT NULL, branch varchar(5) NOT NULL, mobile varchar(11) UNIQUE NOT NULL, dob date NOT NULL, passwd varchar(50) NOT NULL)";
// INSERT table 
...
// Create table status details 
$q = "CREATE TABLE que_btech_cse_level1_tb (que_id int(3) PRIMARY KEY AUTO_INCREMENT, question varchar(150) UNIQUE NOT NULL, choice1 varchar(50) NOT NULL, choice2 varchar(50) NOT NULL, choice3 varchar(50) NOT NULL, choice4 varchar(50) NOT NULL, answer int(2) NOT NULL)";
